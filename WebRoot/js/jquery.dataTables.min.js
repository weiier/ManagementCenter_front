...
this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"显示 _MENU_ 列",sZeroRecords:"没有相匹配的记录",sInfo:"显示 _START_ 至 _END_ 共 _TOTAL_列 ",sInfoEmpty:"显示 0 至 0 共 0 列",sInfoFiltered:"(从 _MAX_ 项过滤)",sInfoPostFix:"",sSearch:"Search:",sUrl:"",oPaginate:{sFirst:"First",sPrevious:"Previous",sNext:"Next",sLast:"Last"}};
...
for(i=0,iLen=_aoSettings.length;i<iLen;i++){if(_aoSettings[i].nTable==this){return _aoSettings[i]}}var oSettings=new classSettings();_aoSettings.push(oSettings);
