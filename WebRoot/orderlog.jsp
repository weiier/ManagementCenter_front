...
<html>
	...
	<script src="js/Myorderlog.js"></script>
        ...
        <div class="fright">
            <div class="header-meta">
                <div id="search-form">
					...
					<div class="text"><input type="text"   id="order" onblur="if(this.value==''){this.value='订单编号';this.style.color='#aaa';}" 
						onfocus="if(this.value=='订单编号'){this.value='';this.style.color='#666';}" value="订单编号">
					</div>
					...
					<table class="display stylized" id="example">
						<thead>
							<tr>
								...
								<th  class="center">trascationID</th>
